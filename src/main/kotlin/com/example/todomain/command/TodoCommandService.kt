...
import com.example.todomain.common.TodoDeleted
...
//        todo.setTitle(updateTodoRequest.getTitle())
        ...
        todo.execution_order = updateTodoRequest.order

        todoRepository.save(todo)

//        publishTodoEvent(todo, TodoUpdated(todo.title, todo.completed, todo?.execution_order))
    }
